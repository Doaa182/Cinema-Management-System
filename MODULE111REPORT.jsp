...
<report name="MODULE111REPORT" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="MODULE111REPORT" xmlPrologType="text">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <userParameter name="HALL_NUMBER" datatype="number" precision="10"
     defaultWidth="0" defaultHeight="0"/>
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL EMPLOYEE.HALL_NO, EMPLOYEE.SALARY, EMPLOYEE.SSN
FROM SYS.EMPLOYEE 
WHERE EMPLOYEE.SALARY>1000
and EMPLOYEE.HALL_NO<=:HALL_NUMBER;]]>
      </select>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_SALARY">
        <displayInfo x="1.45007" y="1.94995" width="1.09998" height="0.43970"
        />
        <dataItem name="SALARY" oracleDatatype="number" columnOrder="12"
         width="22" defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Salary">
          <dataDescriptor expression="EMPLOYEE.SALARY"
           descriptiveExpression="SALARY" order="2" oracleDatatype="number"
           width="22" precision="30"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
      <group name="G_HALL_NO">
        <displayInfo x="1.41394" y="3.13965" width="1.17224" height="0.61963"
        />
        <dataItem name="HALL_NO" oracleDatatype="number" columnOrder="11"
         width="22" defaultWidth="90000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Hall No">
          <dataDescriptor expression="EMPLOYEE.HALL_NO"
           descriptiveExpression="HALL_NO" order="1" oracleDatatype="number"
           width="22" precision="30"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="SSN" datatype="vchar2" columnOrder="13" width="30"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Ssn">
          <dataDescriptor expression="EMPLOYEE.SSN"
           descriptiveExpression="SSN" order="3" width="30"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
    <summary name="MaxSALARYPerReport" source="SALARY" function="maximum"
     width="22" precision="30" reset="report" compute="report"
  ...
  <section name="main">
    <body>
      <frame name="M_G_SALARY_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="2.87500" height="0.75000"
        />
        <generalLayout verticalElasticity="variable"/>
        <visualSettings fillPattern="transparent"
         fillBackgroundColor="r100g100b100"/>
        <repeatingFrame name="R_G_SALARY" source="G_SALARY"
         printDirection="down" minWidowRecords="1" columnMode="no">
          <geometryInfo x="0.00000" y="0.00000" width="2.87500"
           height="0.56250"/>
          <generalLayout verticalElasticity="variable"/>
          <visualSettings fillPattern="transparent"
          ...
          <field name="F_SALARY" source="SALARY" minWidowLines="1" spacing="0"
           alignment="start">
            ...
            />
            <geometryInfo x="0.43750" y="0.00000" width="1.37500"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
            <advancedLayout printObjectOnPage="allPage"
             basePrintingOn="enclosingObject"/>
          </field>
          <frame name="M_G_HALL_NO_GRPFR">
            <geometryInfo x="0.00000" y="0.18750" width="2.87500"
             height="0.37500"/>
            <generalLayout verticalElasticity="variable"/>
            <visualSettings fillPattern="transparent"
             fillBackgroundColor="r100g100b100"/>
            <repeatingFrame name="R_G_HALL_NO" source="G_HALL_NO"
             printDirection="down" minWidowRecords="1" columnMode="no">
              <geometryInfo x="0.00000" y="0.37500" width="2.87500"
               height="0.18750"/>
              <generalLayout verticalElasticity="expand"/>
              <visualSettings fillPattern="transparent"
               fillBackgroundColor="TableCell"/>
              <field name="F_HALL_NO" source="HALL_NO" minWidowLines="1"
              ...
              <field name="F_SSN" source="SSN" minWidowLines="1" spacing="0"
               alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="1.37500" y="0.37500" width="1.50000"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
            </repeatingFrame>
            <frame name="M_G_HALL_NO_HDR">
              <geometryInfo x="0.00000" y="0.18750" width="2.87500"
               height="0.18750"/>
              <advancedLayout printObjectOnPage="allPage"
               basePrintingOn="enclosingObject"/>
              ...
              <text name="B_HALL_NO" minWidowLines="1">
              ...
              <text name="B_SSN" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="1.37500" y="0.18750" width="1.50000"
                 height="0.18750"/>
        ...
        <frame name="M_G_SALARY_FTR">
          <geometryInfo x="0.00000" y="0.56250" width="2.87500"
           height="0.18750"/>
          ...
          <text name="B_MaxSALARYPerReport" minWidowLines="1">
            <textSettings spacing="0"/>
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
      ...
      <text name="B_OR$BODY_SECTION" minWidowLines="1">
        ...
        <geometryInfo x="4.43738" y="0.25000" width="1.93762" height="0.43750"
        />
        <textSegment>
  ...
  <reportPrivate defaultReportType="masterDetail" versionFlags2="0"
   templateName="rwblue" sectionTitle="Cinema"/>
  <reportWebSettings>
  <![CDATA[#NULL#]]>
  </reportWebSettings>
</report>
...
<rw:dataArea id="MGSALARYGRPFR34">
<rw:foreach id="RGSALARY341" src="G_SALARY">
<!-- Start GetGroupHeader/n --> <table class="OraTable">
 <caption class="OraHeader"> Cinema <br>Salary <rw:field id="F_SALARY" src="SALARY" breakLevel="RGSALARY341" breakValue="&nbsp;"> F_SALARY </rw:field><br>
 </caption>
<!-- End GetGroupHeader/n -->   <tr>
    <td valign="top">
    <table class="OraTable" summary="Cinema">
     <!-- Header -->
     <thead>
      <tr>
       <th <rw:id id="HBHALLNO34" asArray="no"/> class="OraColumnHeader"> Hall No </th>
       <th <rw:id id="HBSSN34" asArray="no"/> class="OraColumnHeader"> Ssn </th>
      </tr>
     </thead>
     <!-- Body -->
     <tbody>
      <rw:foreach id="RGHALLNO341" src="G_HALL_NO">
       <tr>
        <td <rw:headers id="HFHALLNO34" src="HBHALLNO34"/> class="OraCellNumber"><rw:field id="FHALLNO34" src="HALL_NO" nullValue="&nbsp;"> F_HALL_NO </rw:field></td>
        <td <rw:headers id="HFSSN34" src="HBSSN34"/> class="OraCellText"><rw:field id="FSSN34" src="SSN" nullValue="&nbsp;"> F_SSN </rw:field></td>
       </tr>
      </rw:foreach>
     </tbody>
     <tr>
...
<table class="OraTable" summary="Cinema">
 <tr>
  <th class="OraTotalNumber"> Maximum: <rw:field id="F_MaxSALARYPerReport" src="MaxSALARYPerReport" nullValue="&nbsp;"> F_MaxSALARYPerReport </rw:field></th>
 </tr>
</table>
</rw:dataArea> <!-- id="MGSALARYGRPFR34" -->
